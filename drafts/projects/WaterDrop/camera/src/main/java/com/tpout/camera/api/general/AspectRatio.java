...
public class AspectRatio implements Comparable<AspectRatio>, Parcelable {
    ...
    /**
     * @return default set or last
     */
    public static AspectRatio chooseDefaultAspectRatio(SizeMap previewSizes) {
        AspectRatio r = null;
        for (AspectRatio ratio : previewSizes.getRatios()) {
            r = ratio;
    ...
    @Override
    public int hashCode() {
        // assuming most getSizes are <2^16, doing a rotate will give us perfect hashing
